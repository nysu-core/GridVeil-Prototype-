...
| Metric | Value |
| --- | ---: |
| Dynamic anomaly threshold | 0.421 |
| Detected anomalies in test set | 7,834 |

The threshold is computed from the 95th percentile of the model's training absolute errors, ensuring that anomaly detection is adaptive and data-driven.
